...
def main():
    print(colored("Starting bci_npc", "green"))
    ...
    try:
        ...
        print(colored('\ndestroying %d vehicles' % len(vehicles_list), 'yellow'))
        ...
        print(colored('\ndestroying %d walkers' % len(walkers_list), 'yellow'))
        client.apply_batch([carla.command.DestroyActor(x) for x in all_id])
        print(colored("NPC Process closed", "red"))
        time.sleep(0.5)
